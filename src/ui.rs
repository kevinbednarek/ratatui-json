...
pub fn ui(f: &mut Frame, app: &App) {
    ...
    let current_navigation_text = vec![
        ...
        match app.current_screen {
            ...
            .to_owned(),
        // A white divider between the two sections
        Span::styled(" | ", Style::default().fg(Color::White)),
        // The final section of text with hints on what the user is editing
        {
    ...
    if let CurrentScreen::Exiting = app.current_screen {
        ...
        let exit_text = Text::styled(
            "Would you like to outp[ut the buffer as json? (y/n)",
            Style::default().fg(Color::Red),
        );
        // The "trim: false" will stop the text from getting cut off when over the edge of the block
